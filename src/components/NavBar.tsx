...
function NavBar() {
  ...
  return (
    <div>
      <nav className="fixesd z-10 w-full border-b border-orange-50/10 bg-emerald-950">
      ...
      {isOpen && (
        <div className="fixed inset-0 z-20 flex flex-col space-y-0 bg-emerald-950 px-20 pt-20 text-5xl font-blod uppercase text-emerald-100 lg:text-6xl">
          <button
