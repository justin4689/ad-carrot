    ...
    <section className="container mx-auto px-4 py-12 md:px-8" id="projects">
      ...
      <div className="space-y-16">
        {PROJECTS.map((project, index) => (
          <div
            key={index}
            className="flex flex-col items-center gap-6 lg:flex-row-reverse md:items-center"
          >
            ...
            <div className="w-full p-8 lg:w-1/2">
              <h2 className="mb-2 text-lg text-emerald-900">{project.year}</h2>
              ...
              <table className="min-w-full text-lg lg:text-xl">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="px-6 py-4 text-emerald-950"> {project.figures.duration} </td>
                    </tr>
                    <tr>
                           <td className="px-6 py-4 font-medium text-emerald-950"> Outcome </td>
                        <td className="px-6 py-4 text-emerald-950"> {project.figures.outcome} </td>
